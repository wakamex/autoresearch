...
- When deployed components, markets, or strategies will compete for shared capital, capacity, inventory, risk, or another finite resource, replay the combined system under the actual shared constraint. Independent component results can explain mechanisms, but they cannot establish portfolio feasibility or the whole-system ranking.
