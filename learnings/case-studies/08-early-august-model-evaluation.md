...
### Diagnostic optimizers need an authority boundary
...
### Nominal labels may compile to equivalent behavior
...
### Participant validity includes provider state and tools
...
### Fixed fixtures become local-tuning surfaces
