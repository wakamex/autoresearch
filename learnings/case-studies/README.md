...
Lengths are generated from the report bodies and exclude frontmatter and this index.
...
The top-level object supplies the collection title, description, latest case date, and repository URL.
Each case supplies `featured_rank`; featured cases have contiguous positive ranks and all others use
`null`. The generator validates the ranks before publishing either view.
