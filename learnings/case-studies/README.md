...
| [`10-trading-strategy-search.md`](10-trading-strategy-search.md) | Quantitative trading autoresearch ran nearly 100 batches in under nine hours and tested thousands of strategy variants while keeping future data untouched for a final test. It made experiments reproducible, reduced the search to genuinely different strategies, and caught that real trading costs changed which ideas could work. | ~950 words | 2026-08-08 to 2026-08-10 |
