...
| [`06-options-market-making-multi-llm.md`](06-options-market-making-multi-llm.md) | Options market-making research used GPT-5.5 for higher-volume implementation, Gemini 3.5 Flash for candidate generation and occasional useful reflections, and scarce Fable 5 capacity mainly to judge evidence and stop dead ends. An independent audit recovered omitted phases, reproducibility gaps, and proposals mistaken for implemented work. A causal-input correction invalidated one promotion-ready candidate, but its replacement survived bounded validation. The broader return disappeared only in a short fresh window after stronger quote competition appeared, making competition-driven edge compression the leading but unproven explanation. | ~1,550 words | 2026-06-22 to 2026-07-10 |
...
| [`10-trading-strategy-search.md`](10-trading-strategy-search.md) | Quantitative trading autoresearch tested low thousands of strategy rules across nearly one hundred batches while reserving a sealed future period for final evaluation. Real deployment costs overturned the leading results, many supposedly different strategies made the same trades, and the long-running agent sometimes stopped researching even while its process remained alive. | ~950 words | 2026-08-08 to 2026-08-10 |
