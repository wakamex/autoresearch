...
| [`10-trading-strategy-search.md`](10-trading-strategy-search.md) | Quantitative trading autoresearch tested low thousands of strategy rules across nearly one hundred batches and built a replayable evaluation pipeline with time-ordered data and a sealed future period. It reduced many lookalike rules to a smaller set of genuinely distinct strategy families, exposed real deployment costs as a decisive input, and showed how to keep long-running agents producing experiments instead of merely staying alive. | ~950 words | 2026-08-08 to 2026-08-10 |
